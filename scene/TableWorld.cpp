...
void TWorldScreen::init()
{
    ...
    // 每關不同背景的圖片
    tworld_img_background_paths[TWorldType::Program]    = "./assets/image/ending/end_fail.jpg";
    tworld_img_background_paths[TWorldType::Calculus] = "./assets/image/ending/end_perfect.jpg";
    tworld_img_background_paths[TWorldType::DataStructure]    = "./assets/image/ending/end_club.jpg";
